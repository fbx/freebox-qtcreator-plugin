...
QByteArray Gzipper::gzip(const QByteArray &ba)
{
    ...
    ds1 << quint16(0x1f8b) << quint16(0x0800) << quint16(0x0000) << quint16(0x0000)
        << quint16(0x000b);
...
{
    return fbx_crc32(~0, (const unsigned char *) data.constData(), data.size()) ^ ~0;
}
